...
- Create publication ready tables using the [GT Tables](https://gt.rstudio.com/) package.
...
For Loop
```{python}
basket = ['apples','cherries','oranges']
...
Nest For Loop
```{python}
ice_cream = ['vanilla','mint chocolate','chocolate']

toppings = ['rum','raisin','cherry','chip']
